...
// Welcome uses a pass by ref to get user input,  
    ...
    * 
    * case 2: (in devlopmentmnt curnely just trigers shutdown after data falure.. )allows you to check in a guest if you enter their ticket number. i have debated between make
