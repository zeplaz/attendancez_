/* 
 * File:   attendants_main0.1.10.cpp
 * revision number alpha.0.1.10.
 * 
 ...
 * welcome will ask for user name and pass. mickey has granted primssion. 
 * the insturction in program will guide you through usage. comments in this file
 * give further outline more details. 
 * 
 * 
 * */
...
// Welcome uses a pass by ref to get user input,  
    ...
    * case 3: \(not implimited yet\) coat check. 
     */
        enum primaySelection {MGL_D, GUES_CHK};
